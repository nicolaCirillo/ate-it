...
- Test set (without labels) ( [CSV](https://github.com/nicolaCirillo/ate-it/blob/main/data/test.csv) \| [JSON](https://github.com/nicolaCirillo/ate-it/blob/main/data/test.json) )
- Test set (with labels) ( CSV \| [JSON](https://github.com/nicolaCirillo/ate-it/blob/main/data/subtask_a_test_with_label.json) )
...
- Test set (with labels) ( CSV \| [JSON](https://github.com/nicolaCirillo/ate-it/blob/main/data/subtask_b_test_with_labels.json) )
