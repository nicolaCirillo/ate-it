...
---
## Deadlines
* **~~January 9, 2026~~ (Extended) *January 12, 2026* (23:59 - CET time zone):** Participant Report Submission
...
For any further publishing questions, please consult the CEUR publishing guide: [https://ceur-ws.org/HOWTOSUBMIT.html](https://ceur-ws.org/HOWTOSUBMIT.html).

The instructions presented here are derived from the official EVALITA 2026 Technical Reports page: [https://www.evalita.it/campaigns/evalita-2026/technical-reports/](https://www.evalita.it/campaigns/evalita-2026/technical-reports/).
